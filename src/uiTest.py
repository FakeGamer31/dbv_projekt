...
class Ui_BrickDetector(QtWidgets.QMainWindow):
    def setupUi(self, BrickDetector=None):
        ...
        self.camera_settings_box.setGeometry(QtCore.QRect(700, 30, 231, 171))
        ...
        self.static_radio.setGeometry(QtCore.QRect(10, 130, 82, 17))
        ...
        self.live_radio.setGeometry(QtCore.QRect(10, 110, 82, 17))
        ...
        self.image_label.setGeometry(QtCore.QRect(10, 90, 81, 16))
        ...
        self.focus_label.setBuddy(self.focus_slider)      # OpenCV VideoCapture für die Kamera erstellen (hier wird die Kamera mit der ID 0 verwendet)
        self.cap = cv2.VideoCapture(0)     # QTimer erstellen, um das Bild regelmäßig zu aktualisieren
        self.timer = QtCore.QTimer(self)
        self.timer.timeout.connect(self.load_image_bbrick)
        self.timer.start(3)  # Aktualisiere alle 30 Millisekunden
    ...
    def retranslateUi(self, BrickDetector=None):
    ...
    def load_image_bbrick(self):
        # Bild von der Kamera erfassen
        ret, frame = self.cap.read()

        if ret:
            # OpenCV Bild in QImage umwandeln
